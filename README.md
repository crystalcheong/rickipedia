...
<p align="center">
  A <a href="https://en.wikipedia.org/wiki/Rick_and_Morty" target="_blank">Rick and Morty</a> character wiki built with <a href="https://nextjs.org/" target="_blank">Next.js</a> and hosted with <a href="https://vercel.com/" target="_blank">Vercel</a>
</p>
...
```sh
git clone https://github.com/crystalcheong/Rickipedia.git
```
